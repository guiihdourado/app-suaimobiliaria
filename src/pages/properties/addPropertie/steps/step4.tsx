...
const Step4: React.FC<Step3Props> = ({  register, setValue, watch, formState }) => {
    ...
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-12">
        <div className="flex flex-col gap-4">
          ...
          <ImageInput name="images" register={register} setValue={setValue} value={images} errorMessage={formState?.errors?.images?.message} />
        </div>
      </div>
    </div>
  )
